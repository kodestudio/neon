...
config style
*/
const config_style_issue = '<div class="card-header"><a href="UserUrlValue"><img class="img-thumbnail rounded-circle" src="AvatarUrl" style="width: 50px; height: 50px;"></a><a href="UserUrlValue"><strong>UserNameValue</strong></a><i>ActionValue</i></div><div class="card-body"><h3>TitleValue</h3><hr class="my-4"><div style="overflow: auto">BodyValue</div></div><div class="card-footer"><a href="GitHubValue"><button class="btn btn-outline-primary"><i class="fab fa-github"></i></button></a><i style="float: right;">20/20/20</i></div>';
